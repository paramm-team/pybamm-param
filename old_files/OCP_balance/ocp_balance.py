...
class ocp(object):
    ...
    def anode_plot(self, a_anode, b_anode):
        self.a_anode = a_anode
        self.b_anode = b_anode
        ...
        def capacity2stoic(x):
            return (a_anode*x)+b_anode
        def stoic2capacity(x):
            return (x-b_anode)/a_anode
    ...
    def cathode_plot(self, a_cathode, b_cathode):
        self.a_cathode = b_cathode
        self.b_cathode = b_cathode
        ...
        def capacity2stoic(x):
            return (a_cathode*x)+b_cathode
        def stoic2capacity(x):
            return (x-b_cathode)/a_cathode
