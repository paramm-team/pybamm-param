...
If you wish to contribute to PyBaMM-param, you should get the latest version
...
To install PyBaMM-param, the first step is to get the code by cloning this
repository
...
Then, to install PyBaMM-param as a `developer <https://github.com/paramm-team/pybamm-param/blob/main/CONTRIBUTING.md>`__, type

 .. code:: bash

   pip install -e .[dev,docs]

To check whether PyBaMM-param has installed properly, you can run the tests:
...
guidelines <https://github.com/paramm-team/pybamm-param/blob/main/CONTRIBUTING.md>`__.
...
**Problem:** I’ve made edits to source files in PyBaMM-param, but these are
not being used when I run my Python script.

**Solution:** Make sure you have installed PyBaMM-param using the ``-e`` flag,
