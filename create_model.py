...
class model_build:
    ...
    def __init__(self, temperature, crate, cells_ignore):  
    
        self.globals = {'temperature':temperature, 'crate':crate, 'cells_ignore':cells_ignore}
        
   # def define_model(self):
        global simulation, data_conc, param
        temperature=self.globals["temperature"]
        crate = self.globals["crate"]
        cells_ignore = self.globals["cells_ignore"]
